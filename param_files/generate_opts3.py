...
out1.write("""maker_gff=""" + maker_gff + """ #MAKER derived GFF3 file\n""")
out1.write("""est_pass=1 #use ESTs in maker_gff: 1 = yes, 0 = no\n""")
out1.write("""altest_pass=1 #use alternate organism ESTs in maker_gff: 1 = yes, 0 = no\n""")
out1.write("""protein_pass=1 #use protein alignments in maker_gff: 1 = yes, 0 = no\n""")
out1.write("""rm_pass=0 #use repeats in maker_gff: 1 = yes, 0 = no\n""")
out1.write("""model_pass=1 #use gene models in maker_gff: 1 = yes, 0 = no\n""")
out1.write("""pred_pass=1 #use ab-initio predictions in maker_gff: 1 = yes, 0 = no\n""")
...
out1.write("""snaphmm=""" + snap_gff + """ #SNAP HMM file\n""")
out1.write("""gmhmm= #GeneMark HMM file\n""")
out1.write("""augustus_species= #Augustus gene prediction species model\n""")
...
out1.write("""est2genome=0 #infer gene predictions directly from ESTs, 1 = yes, 0 = no\n""")
out1.write("""protein2genome=0 #infer predictions from protein homology, 1 = yes, 0 = no\n""")
